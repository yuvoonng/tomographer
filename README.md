...
## Installation
0. Git Large File Storage (LFS): Skip if installed. Install [Git LFS](https://git-lfs.com/) to enable cloning large files (~3 GB in the core repository). Example using `conda`:
```bash

...
## Installation
0. Git Large File Storage (LFS): Skip if already installed. Install [Git LFS](https://git-lfs.com/) to clone the large files (~3 GB) in the core repository. Example using `conda`:
```bash
